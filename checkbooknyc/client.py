...
class Budget(CheckbookNYCClient):
    def __init__(
        self,
        session: requests.Session,
        base_url: str = "https://www.checkbooknyc.com/api",
    ...
    def fetch(
        ...
        **filters: Dict[str, Union[str, int, float]],
        ...
        """
        Sends a POST request to the budget endpoint with given filter criteria.
        """
        if get_all_records:
            return self._fetch_all_records(response_columns, **filters)
        else:
            xml_body = self.build_budget_request(
...
class Revenue(CheckbookNYCClient):
    def __init__(
        self,
        session: requests.Session,
        base_url: str = "https://www.checkbooknyc.com/api",
...
class Spending(CheckbookNYCClient):
    def __init__(
        self,
        session: requests.Session,
        base_url: str = "https://www.checkbooknyc.com/api",
...
class Payroll(CheckbookNYCClient):
    def __init__(
        self,
        session: requests.Session,
        base_url: str = "https://www.checkbooknyc.com/api",
